...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PF12     ------> ADC1_INP6
    */
    GPIO_InitStruct.Pin = ADC_VA_CH2_Pin|ADC_VA_CH6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_VA_CH3_Pin|ADC_VA_CH7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_VA_CH8_Pin|ADC_VA_CH4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_VA_CH1_Pin|ADC_VA_CH5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PF12     ------> ADC1_INP6
    */
    HAL_GPIO_DeInit(GPIOA, ADC_VA_CH2_Pin|ADC_VA_CH6_Pin);

    HAL_GPIO_DeInit(GPIOC, ADC_VA_CH3_Pin|ADC_VA_CH7_Pin);

    HAL_GPIO_DeInit(GPIOB, ADC_VA_CH8_Pin|ADC_VA_CH4_Pin);

    HAL_GPIO_DeInit(GPIOF, ADC_VA_CH1_Pin|ADC_VA_CH5_Pin);
